...
export const SERVERLESS_BATCH_BUDGET_MS = 285_000;

/** 이보다 적게 남으면 새 캡처를 시작하지 않고 남은 작업을 실패 처리 */
export const MIN_REMAINING_FOR_HARD_SKIP_MS = 32_000;
...
export function resolveBatchPerCaptureTimeoutMs(
  ...
  return Math.min(55_000, Math.max(24_000, remaining - 12_000));
}
