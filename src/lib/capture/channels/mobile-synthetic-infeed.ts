...
export function generateMobileSyntheticInfeedHomeHtml(
  ...
  const iconCompass = `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2.19-5.19L15 9l-5.81 2.19L7 17l5.81-2.19zm2.46-3.08-1.77 1.77-1.77-1.77 1.77-1.77 1.77 1.77z"/></svg>`;
  ...
  const iconShortsOutline = `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"><path d="M17.77 10.32l-1.2-.5L18 9.06c1.84-.85 2.56-3 1.62-4.72A3.525 3.525 0 0 0 14.87 2.74L6.33 6.69C4.49 7.54 3.77 9.7 4.71 11.42a3.524 3.524 0 0 0 2.22 1.83l1.2.5L6 14.94c-1.84.85-2.56 3-1.62 4.72a3.525 3.525 0 0 0 4.75 1.6l8.54-3.95c1.84-.85 2.56-3 1.62-4.72a3.524 3.524 0 0 0-1.52-2.27z"/><path d="M10 14.65v-5.3L15 12l-5 2.65z"/></svg>`;
    ...
    <div style="width:100%;display:flex;flex-direction:column;margin-bottom:28px;">
      ...
      <div style="display:flex;padding:12px 16px 0 16px;gap:12px;align-items:flex-start;">
        ...
        <div style="flex:1;display:flex;flex-direction:column;width:0;">
          ...
          ` : ""}
          <div style="font-size:12px;color:#606060;margin-top:${adData.description ? '4px' : '0px'};display:flex;align-items:center;gap:4px;">
